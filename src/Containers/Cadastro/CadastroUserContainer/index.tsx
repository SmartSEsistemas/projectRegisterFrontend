...
export const Cadastro = () => {
  ...
  const validationSchema = z
    .object({
      ...
      dataNascimento: z.string().refine((value) => isOlderThan18(value), {
              ...
              return (
                <ContainerDiv key={field.name} isLast={isLast}>
                  ...
                  {field.name === 'passwordRegister' && (
                    <ContainerInfoHelp>
                      <MensageStrength>
                        Para sua segurança, crie uma senha com no mínimo 6
                        caracteres. Lembre-se de combinar letras maiúsculas e
                        minúsculas, e incluir também números. Faça a sua senha
